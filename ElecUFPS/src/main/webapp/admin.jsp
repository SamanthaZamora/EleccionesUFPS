...
<body>
	...
	<div class="container">
		<div class="row">			
			<div class="col">
				<div class="opcion">
					<a href="#" style="text-decoration: none" ><p class="op_nombre">Registro de Candidatos</p></a>
				</div>
				<br>
				<div class="opcion">
				...
				<br>
				<div class="opcion">
					<a href="#" style="text-decoration: none" ><p class="op_nombre">Votos Registrados</p></a>
				</div>
			</div>
		</div>
	</div>
